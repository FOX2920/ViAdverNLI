...
export const errorTypeData = [
  { model: "mBERT", errorType: "SUPPORTED → NEI", count: 1500, percentage: 36.5 },
  { model: "mBERT", errorType: "REFUTED → NEI", count: 1000, percentage: 24.4 },
  { model: "mBERT", errorType: "NEI → REFUTED", count: 250, percentage: 6.1 },
  { model: "mBERT", errorType: "NEI → SUPPORTED", count: 100, percentage: 2.4 },
  { model: "PhoBERT", errorType: "NEI → SUPPORTED", count: 800, percentage: 24.5 },
  { model: "PhoBERT", errorType: "NEI → REFUTED", count: 600, percentage: 18.4 },
  { model: "PhoBERT", errorType: "REFUTED → SUPPORTED", count: 400, percentage: 12.3 },
  { model: "PhoBERT", errorType: "SUPPORTED → REFUTED", count: 300, percentage: 9.2 },
  { model: "XLM-R", errorType: "REFUTED → NEI", count: 1800, percentage: 38.3 },
  { model: "XLM-R", errorType: "SUPPORTED → NEI", count: 1500, percentage: 31.9 },
  { model: "XLM-R", errorType: "NEI → SUPPORTED", count: 400, percentage: 8.5 },
  { model: "XLM-R", errorType: "REFUTED → SUPPORTED", count: 200, percentage: 4.3 },
]
