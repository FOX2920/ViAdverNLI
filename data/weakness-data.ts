...
export const weaknessData = [
  {
    ...
    round: "R1",
    totalSamples: 5347,
    correctPredictions: 1239,
    incorrectPredictions: 4108,
    accuracy: 23.17,
    errorRate: 76.83,
  ...
  },
  {
    ...
    round: "R2",
    totalSamples: 5961,
    correctPredictions: 2698,
    incorrectPredictions: 3263,
    accuracy: 45.26,
    errorRate: 54.74,
  ...
  },
  {
    ...
    round: "R3",
    totalSamples: 9954,
    correctPredictions: 5256,
    incorrectPredictions: 4698,
    accuracy: 52.80,
    errorRate: 47.20,
...
export const errorTypeData = [
  { model: "mBERT", errorType: "SUPPORTED → NEI", count: 1842, percentage: 44.8 },
  { model: "mBERT", errorType: "REFUTED → NEI", count: 1547, percentage: 37.7 },
  { model: "mBERT", errorType: "NEI → REFUTED", count: 194, percentage: 4.7 },
  { model: "mBERT", errorType: "NEI → SUPPORTED", count: 184, percentage: 4.5 },
  { model: "mBERT", errorType: "SUPPORTED → REFUTED", count: 178, percentage: 4.3 },
  { model: "mBERT", errorType: "REFUTED → SUPPORTED", count: 163, percentage: 4.0 },
  { model: "PhoBERT", errorType: "NEI → SUPPORTED", count: 1110, percentage: 34.0 },
  { model: "PhoBERT", errorType: "NEI → REFUTED", count: 761, percentage: 23.3 },
  { model: "PhoBERT", errorType: "REFUTED → SUPPORTED", count: 605, percentage: 18.5 },
  { model: "PhoBERT", errorType: "SUPPORTED → REFUTED", count: 428, percentage: 13.1 },
  { model: "PhoBERT", errorType: "SUPPORTED → NEI", count: 180, percentage: 5.5 },
  { model: "PhoBERT", errorType: "REFUTED → NEI", count: 179, percentage: 5.5 },
  { model: "XLM-R", errorType: "REFUTED → NEI", count: 1933, percentage: 41.1 },
  { model: "XLM-R", errorType: "SUPPORTED → NEI", count: 1723, percentage: 36.7 },
  { model: "XLM-R", errorType: "NEI → SUPPORTED", count: 301, percentage: 6.4 },
  { model: "XLM-R", errorType: "REFUTED → SUPPORTED", count: 282, percentage: 6.0 },
  { model: "XLM-R", errorType: "SUPPORTED → REFUTED", count: 264, percentage: 5.6 },
  { model: "XLM-R", errorType: "NEI → REFUTED", count: 195, percentage: 4.2 },
]
